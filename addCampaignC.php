...
//currency
    ...
    if ($Validflag == 1) {
        ...
        foreach ($values as $value) {
            ...
            $query = "INSERT INTO coupons (CouponImage,Pushed, Availed, OutletId, TypeId, SubType, EndTime, DealStatement, StartTime, MerchantId, CreatedOn, IsDeleted, dealtype)";
            $query .= " values ('$path',$tempToken, 0,$tempId,42,'$subType',$eDate,'$deal',$sDate,$uid,now(),0,0)";
