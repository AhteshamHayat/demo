            ...
            function codeAddress(address) {
                geocoder.geocode({'address': address}, function (results, status) {
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        map.setZoom(13);
                        document.getElementById('markMap').innerHTML = "<p style='color: grey'>Please mark the location on the map</p>"
                    } else {
                ...
                <div class="col-xs-9">
                    <div class='row'>
                        <div class='panel panel-primary' style='background: #FFF; padding-left: 20px;padding-right: 20px; border-radius: 4px;'>
                            ...
                            <form class="form-horizontal" action="addOutlet.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <select class="form-control" name="category" id="category">
                                            <option value="" disabled="" selected="" style="display: none;color: gray">Select category</option>
                                            <?php
                                            $query = "SELECT * FROM types t where TypeId <> 42 and TypeId <> 43;";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='col-xs-9 col-xs-offset-3' style='margin-top: 0px; font-size: 16px; color: #3278b3'>
                                        <a class='btn btn-info btn-sm' href="#" onclick="document.getElementById('inputLogo').click();
                                                return false;" style='margin-left: 1px; width: 150px;'>Upload Logo </a>
                                        <a class='btn btn-info btn-sm' href="#" onclick="document.getElementById('inputCover').click();
                                                return false;" style='margin-left: 5px; width: 450px;'>Upload Cover Photo </a>
                                    </div>
                                </div>
